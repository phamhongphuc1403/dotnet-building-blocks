...
public class OperationRepository<TDbContext, TAggregateRoot> : UnitOfWork<TDbContext>,
    IOperationRepository<TAggregateRoot>
    ...
    where TAggregateRoot : class, IAggregateRoot
{
    ...
    public OperationRepository(TDbContext dbContext) : base(dbContext)
    {
